...
class Asik_model extends CI_Model {
    ...
    public $module = array(
        ...
        array(
            ...
            '21214303' => ['cashreceived','O/S Outlet Received'],
            '21214304' => ['cashreturned','O/S Outlet Returned'],
            '21214305' => ['receiveinbank','O/S Receive'], //Receive in Bank change to O/S Receive (2018-07-09)
            '21214306' => ['openingbalance','Opening Balance']
        ),
        array(
        ...
        array(
            ...
            '41214302' => ['cashreceiptreport','Cash Receipt'],
            '41214303' => ['expensereport','Expenses'],
            '41214304' => ['outstandingreport','O/S Cash Request'],
            '41214305' => ['outstandingreport','O/S Outlet'],
            '41214306' => ['outstandingreport','O/S Third Party'],
            '41214307' => ['Supplierreport','Supplier'],
            '41214308' => ['report','Journal'],
            '41214309' => ['report','Ledger'],
            '41214310' => ['report','Trial Balance'],
            '41214311' => ['crbalance','Cash Request Balance'],
            '41214312' => ['supplierbalance','Supplier Balance'],
            '41214313' => ['projectbalance','Project Balance'],
            '41214314' => ['thirdpartybalance','Third Party Balance']
        ),
        array(
            ...
            '51214305' => ['employee','Person'],
            '51214306' => ['period','Period'],
            '51214307' => ['bank','Bank'],
            '51214308' => ['thirdparty','Third Party'],
            '51214309' => ['vendor','Vendor'],
        ),
        array(
    ...
    public $report_09 = '41214309';
    public $report_10 = '41214310';
    public $report_11 = '41214311';
    public $report_12 = '41214312';
    public $report_13 = '41214313';
    public $report_14 = '41214314';
    /*masterdata*/
    ...
    public $master_08 = '51214308';
    public $master_09 = '51214309';
    /*system*/
    ...
    public $action_cross_check = '021910';
