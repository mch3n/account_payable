<div class="col-xs-12">
    <div class="box box-primary">
        <form class="form-inline" role="form" name="filterdata" method="post" action="<?php echo site_url('summaryreportnew/go/'.$pagecode) ?>">
            ...
            <div class="box-header with-border">
                ...
                <div class="input-group">
                    <div class="btn-group">
                        <a href="<?php echo site_url('summaryreportnew/go/'.$pagecode.'/1/') ?>" class="btn btn-default">Today</a>
                        <a href="<?php echo site_url('summaryreportnew/go/'.$pagecode.'/2/') ?>" class="btn btn-default">Yesterday</a>
                        <a href="<?php echo site_url('summaryreportnew/go/'.$pagecode.'/3/') ?>" class="btn btn-default">This Week</a>
                        <a href="<?php echo site_url('summaryreportnew/go/'.$pagecode.'/4/') ?>" class="btn btn-default">This Month</a>
                        <a href="<?php echo site_url('summaryreportnew/go/'.$pagecode.'/5/') ?>" class="btn btn-default">Last Month</a>
                        <a href="<?php echo site_url('summaryreportnew/go/'.$pagecode.'/6/') ?>" class="btn btn-default">Up to Today</a>
                    </div>
                </div>
                ...
                if (sizeof($array_tbl)!=0){
                    ...
                    for($i=0; $i<=sizeof($array_tbl); $i++){
                        if (isset($array_tbl[$i][0])){
                            ...
                            $k = 0;
                            foreach ($branch as $b) {
                                echo '<td class="text-right">'.$array_tbl[$i][$k+1]. '</td>';
                                $k++;
                            }
                            echo '<td class="text-right">'.number_format($array_tbl[$i][$k+1]). '</td>';
                            echo '</tr>';
                        }                        
                        $no++;
                    }
