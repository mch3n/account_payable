<div class="col-xs-12">
    <div class="box box-primary">
        <form class="form-inline" role="form" name="filterdata" method="post" action="<?php echo site_url('supplierreportnew/go/'.$pagecode) ?>">
            <div class="box-header with-border">
                ...
                <div class="input-group">
                    <div class="btn-group">
                        <a href="<?php echo site_url('supplierreportnew/go/'.$pagecode.'/1/') ?>" class="btn btn-default">Today</a>
                        <a href="<?php echo site_url('supplierreportnew/go/'.$pagecode.'/2/') ?>" class="btn btn-default">Yesterday</a>
                        <a href="<?php echo site_url('supplierreportnew/go/'.$pagecode.'/3/') ?>" class="btn btn-default">This Week</a>
                        <a href="<?php echo site_url('supplierreportnew/go/'.$pagecode.'/4/') ?>" class="btn btn-default">This Month</a>
                        <a href="<?php echo site_url('supplierreportnew/go/'.$pagecode.'/5/') ?>" class="btn btn-default">Last Month</a>
                        <a href="<?php echo site_url('supplierreportnew/go/'.$pagecode.'/6/') ?>" class="btn btn-default">Up to Today</a>
                    </div>
                </div>
            </div>
            <!--- --->
            ...
            <div class="box-header with-border">
                <div class="input-group">
                    <div class="btn-group">
                        <a href="< echo site_url('supplierreportnew/outlet/'.$pagecode.'/1/') ?>" class="btn btn-default">QTR</a>
                        <a href="< echo site_url('supplierreportnew/outlet/'.$pagecode.'/2/') ?>" class="btn btn-default">QOI</a>
                        <a href="< echo site_url('supplierreportnew/outlet/'.$pagecode.'/3/') ?>" class="btn btn-default">QND</a>
                        <a href="< echo site_url('supplierreportnew/outlet/'.$pagecode.'/4/') ?>" class="btn btn-default">QUB</a>
                        <a href="< echo site_url('supplierreportnew/outlet/'.$pagecode.'/5/') ?>" class="btn btn-default">Mess</a>
                    </div>
                </div>
            </div> -->
        </form>
            ...
            <table id="datatable2" class="table table-striped table-bordered">
                ...
                if (sizeof($array)!=0){
                    ...
                    for($i=0; $i<sizeof($array); $i++){
                        echo '<tr>';
                        echo '<td>'.$no.'</td>';
                        echo '<td><a href="'. site_url('supplierreportnew/supplier_detail/'.$pagecode.'/'.$array[$i][sizeof($branch)+2]). '">'.$array[$i][0].'</a></td>';
                        $k = 0;
                        foreach ($branch as $b) {
