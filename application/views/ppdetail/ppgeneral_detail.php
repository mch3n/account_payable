    ...
    <div class="box box-default">
        <div class="box-header with-border">
            ...
            <div class="pull-right" style="text-align: right">
                ...
                <?php
                if ($row->cash_request_id != 0){
                    $cash_request_number = $this->ppdetail_model->get_cash_request_number($row->cash_request_id);
                    $enccr_id = $this->general_model->encrypt_value($row->cash_request_id);
                    echo '<div>CR NO: <a href="'. site_url('cashrequest/cdetail/20191121214302/'.$enccr_id).'">'.$cash_request_number.'</a></div>';
                }
                ?>
                <?php
        ...
        <div class="box-body table-responsive">
            ...
            <table class="table table-bordered">
                <tbody>
                    <?php
                    if ($row->pp_status < 2){
                        echo form_open('ppdetail/ppgeneral_action');
