...
<script type="text/javascript">
    ...
    function add_data()
    {
        ...
        $('.modal-title').text('Add Project Debit'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_data(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('projectdebit/ajax_edit/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data)
            {                
                $('[name="project_debit_id"]').val(data.project_debit_id);
                $('[name="project_number"]').val(data.project_number);
    ...
    function save()
    {
        ...
        if (save_method == 'add')
        {
            url = "<?php echo site_url('projectdebit/projectdebit_add') ?>";
        }
        else
        {
            url = "<?php echo site_url('projectdebit/projectdebit_update') ?>";
        }
    ...
    function delete_data(id)
    {
        if (confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url: "<?php echo site_url('projectdebit/projectdebit_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data)
                {
