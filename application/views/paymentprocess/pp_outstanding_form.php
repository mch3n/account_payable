<?php 
$actionlink = 'paymentprocess/ppoutstanding/20191231214301/';
if ($param_pp_id == 0){
    $actionlink = 'paymentprocess/ppoutstanding/20191231214301/0/0/1/';
} else {
    $actionlink = 'paymentprocess/ppoutstanding/20191231214301/'.$param_pp_id.'/0/2/';
}
...
<div class="col-md-12">
    <div class="box box-danger">
        <div class="box-header with-border">
            <h4 class="text-danger">Header of PP</h4>
            <?php 
            echo $pp_id; 
            echo $pp_number;
            ?>
            <table width="100%" class="table">
                ...
                <tr>
                    <td>
                        <?php 
                        if ($is_third_party_id == 0){
                            echo $third_party_id;
                        } else {
                            echo '<strong>'.$label_third_party_id.'</strong>';
                        }
                        ?>
                    </td>
                    <td>&nbsp;</td>
